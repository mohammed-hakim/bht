...
export const features = [
  {
    id: "0",
    icon: "/images/feature-1.png",
    caption: "Confort & Sécurité",
    title: "Un cadre de vie paisible",
    text: "Profitez d’un environnement sécurisé avec des installations modernes assurant votre confort au quotidien.",
    button: {
      icon: "/images/magictouch.svg",
  ...
  },
  {
    ...
    title: "Prête à l’usage",
    text: "Chaque appartement est doté d’une cuisine moderne entièrement équipée, prête à accueillir vos moments culinaires.",
    button: {
      icon: "/images/docs.svg",
      title: "Découvrir l’équipement",
    },
  },
];
...
//     id: "0",
//     icon: "/images/detail-1.png",
//     title: "Offre de Parking",
   
//   },
//   {
//     id: "1",
//     icon: "/images/detail-2.png",
//     title: "Antenne Satellite Collective",
//   },
//   {
//     id: "2",
//     icon: "/images/detail-3.png",
...
//     id: "3",
//     icon: "/images/detail-4.png",
//     title: "2 Ascenseurs par Bloc",
//   },
//   {
//     id: "4",
//     icon: "/images/detail-1.png",
//     title: "Salle de Bains Équipée",
//   },
//   {
//     id: "5",
//     icon: "/images/detail-2.png",
...
export const details = [
  {
    id: "0",
    icon: "/icons/square-parking.svg",
    title: "Offre de Parking",
  },
  {
    id: "1",
    icon: "/icons/satellite-dish.svg",
    title: "Antenne Satellite Collective",
  },
  {
    id: "2",
    icon: "/icons/thermometer-snowflake.svg",
    title: "Chauffage & Climatisation",
  },
  {
    id: "3",
    icon: "/icons/door-open.svg", // utilisé ici comme alternative à ascenseur
    title: "2 Ascenseurs par Bloc",
  },
  {
    id: "4",
  ...
  {
    id: "5",
    icon: "/icons/hotel.svg", // symbolique pour la gestion immobilière
    title: "Gestion de Copropriété",
  },
];
...
export const newLots = [
  {
    id: "F2",
    image: "/images/new/image.jpg",
    title: "Appartement F2",
    description: "Superficie 70 m².",
    button: {
      icon: "/images/docs.svg",
      title: "Découvrir l’équipement",
    },
    text: "Appartement F2 fonctionnel avec une chambre, un salon, une cuisine et une salle de bain. Parfait pour célibataires ou jeunes couples.",
  },
  {
    id: "F3",
    ...
    description: "Superficie 95 m².",
    button: {
      icon: "/images/docs.svg",
      title: "Découvrir l’équipement",
    },
    text: "Appartement F3 confortable comprenant 2 chambres, un salon lumineux et une cuisine moderne. Idéal pour une petite famille.",
  },
  {
    id: "F4",
    ...
    description: "Superficie 120 m².",
    button: {
      icon: "/images/docs.svg",
      title: "Découvrir l’équipement",
    },
    text: "Appartement F4 spacieux avec 3 chambres, un grand salon et une cuisine équipée. Situé dans un quartier calme et résidentiel.",
  },
  {
    id: "Duplex",
    ...
    description: "Superficie 160 m².",
    button: {
      icon: "/images/docs.svg",
      title: "Découvrir l’équipement",
    },
    text: "Duplex élégant sur deux niveaux avec terrasse, 3 chambres et un espace de vie lumineux. Offrant confort et modernité.",
  },
];
...
export const faq = [
  {
    ...
    answer:
      "Nous proposons des appartements F2, F3, F4 ainsi que des duplex modernes, pensés pour offrir confort, luminosité et fonctionnalité à tous types de foyers.",
  },
  {
    id: "1",
    question: "Les logements sont-ils livrés finis ?",
    answer:
      "Oui, tous nos logements sont livrés entièrement finis avec des matériaux de qualité : revêtements modernes, cuisine équipée, sanitaires posés et peinture soignée.",
  },
  {
    id: "2",
    question: "Est-ce que chaque appartement dispose d’un parking ?",
    answer:
      "Absolument. Chaque lot comprend une place de stationnement sécurisée, avec option de parking couvert ou box fermé selon la formule choisie.",
  },
  {
    id: "3",
    question: "Quelle est la superficie des appartements ?",
    answer:
      "Les superficies varient selon le type : F2 autour de 65 m², F3 environ 85 m², F4 jusqu'à 120 m², et les duplex peuvent dépasser 160 m².",
  },
  {
    id: "4",
    question: "Proposez-vous des facilités de paiement ?",
    answer:
      "Oui, nous proposons des plans de paiement souples adaptés à votre budget, avec possibilité de financement via des partenaires bancaires.",
  },
  {
    id: "5",
    question: "Le quartier est-il bien desservi ?",
    answer:
...
export const testimonials = [
  ...
  },
  {
    ...
    avatarUrl: "/images/testimonials/mark-erixon.png",
    comment:
      "L'équipe a été à l'écoute du début à la fin. Un service transparent et très professionnel.",
  },
  {
    id: "3",
    name: "Fouad Meziani",
    role: "Chef d'entreprise, Sétif",
    avatarUrl: "/images/testimonials/jim-bradley.png",
    comment:
      "L’achat de notre duplex s’est fait sans encombre. Nous sommes ravis de la qualité de finition.",
  },
  {
    id: "4",
    name: "Karima Bouzid",
    role: "Fonctionnaire, Blida",
    avatarUrl: "/images/testimonials/jim-bradley.png",
    comment:
...
let detaisImgs = [
  "/images/lots/f2/01/03.jpg",
  "/images/lots/f2/01/04.png",
  "/images/lots/f2/01/05.png",
  "/images/lots/f2/01/06.png",]
export const lotData = {
  F2: [
    {
      id: 1,
      surface: "70 m²",
      planImage:"/images/lots/f2/01/01.jpg",// "/images/f2/plan1.jpg",
      details: [
        "/images/lots/f2/01/01.jpg",
        "/images/lots/f2/01/02.png",
        ...detaisImgs
      ],
      disponible:true,
      floors: [1, 2, 3, 12, 13, 14, 15] // <-- precise list
    },
  ...
  F3: [
    {
      id: 3,
      surface: "95 m²",
      planImage:"/images/lots/f3/01/01.jpg",// "/images/f3/plan1.jpg",
      details: [
        "/images/lots/f3/01/01.jpg",
        "/images/lots/f3/01/02.png",
        ...detaisImgs
      ],
      disponible:true,
      floors: [1, 2, 3, 12, 13, 14, 15] // <-- precise list
    },
    {
      id: 4,
      surface: "105 m²",
      planImage:"/images/lots/f3/02/01.jpg",// "/images/f3/plan1.jpg",
      details: [
        "/images/lots/f3/02/01.jpg",
        "/images/lots/f3/02/02.png",
        ...detaisImgs
      ],
      disponible:false,

      floors: [5,6,7] // <-- precise list
  ...
  F4: [
    {
      id: 5,
      surface: "120 m²",
      planImage:"/images/lots/f4/01/01.jpg",// "/images/f4/plan1.jpg",
      details: [
        "/images/lots/f4/01/01.jpg",
        "/images/lots/f4/01/02.png",
        ...detaisImgs
      ],
      disponible:true,
      floors: [1, 2, 3, 12, 13, 14, 15] // <-- precise list
    },
    {
      id: 6,
      surface: "135 m²",
      planImage:"/images/lots/f4/02/01.jpg",// "/images/f4/plan1.jpg",
      details: [
        "/images/lots/f4/02/01.jpg",
        "/images/lots/f4/02/02.png",
        ...detaisImgs
      ],
      disponible:false,
    ...
    },
    {
      id: 7,
      surface: "140 m²",
      planImage:"/images/lots/f4/03/01.png",// "/images/f4/plan1.png",
      details: [
        "/images/lots/f4/03/01.png",
        "/images/lots/f4/03/02.png",
        ...detaisImgs
      ],
      disponible:true,

      floors: [1,5,12] // <-- precise list
  ...
  Duplex:[
    {
      id: 8,
      surface: "160 m²",
      planImage:"/images/lots/duplex/01/01.jpg",// "/images/duplex/plan1.jpg",
      details: [
        "/images/lots/duplex/01/01.jpg",
        "/images/lots/duplex/01/02.png",
        ...detaisImgs
      ],
      disponible:true,
      floors: [1, 2, 3, 12, 13, 14, 15] // <-- precise list
    },
    {
      id: 4,
      surface: "175 m²",
      planImage:"/images/lots/duplex/02/01.jpg",// "/images/duplex/plan1.jpg",
      details: [
        "/images/lots/duplex/02/01.jpg",
        "/images/lots/duplex/02/02.png",
        ...detaisImgs
      ],
      disponible:false,
